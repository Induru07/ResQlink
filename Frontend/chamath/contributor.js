<<<<<<< Updated upstream:Frontend/chamath/contributor.js
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const dashboard = document.getElementById('contributor-dashboard');
    const loginMsg = document.getElementById('login-required-msg');

    if (!token || !user || user.role !== 'supplier') {
        // Not logged in or not a supplier
...
>>>>>>> Stashed changes:Frontend/js/contributor.js
}